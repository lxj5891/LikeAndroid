...
import com.starwall.like.api.ApiClient;
import com.starwall.like.api.UserModule;
    ...
    public void onCreate() {
        ...
        new Thread(){
            public void run() {
                ...
                try {
                    UserModule.login((AppContext) getApplicationContext(), "admin", "admin");
